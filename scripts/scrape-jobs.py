"""Scrape a fresh chunk of genuine Swiss roof and envelope jobs into JSON.
...
from job_safety import CONFIG as JOB_SAFETY_CONFIG, classify_dachdecker_title
...
def is_relevant_job(job: dict) -> bool:
    """Return True only for clearly roof-related Swiss roles."""
    ...
    return classify_dachdecker_title(title)["disposition"] == "ACCEPT"
...
def main():
    parser = argparse.ArgumentParser(description="Scrape Swiss roof and building-envelope jobs")
