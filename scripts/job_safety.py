"""Shared deny-first Dach- und Fassadenbau classifier backed by src/config/job-safety.json."""
...
def classify_dachdecker_title(title_value: Any) -> dict[str, Any]:
    ...
    if not match:
        return {"disposition": "REJECT", "reason": "no-dachdecker-title-signal"}
    ...
    return {
        "disposition": "ACCEPT",
        "reason": "specific-dachdecker-title" if specific else "broad-role-with-dachdecker-context",
