...
export const metadata: Metadata = {
  ...
  description:
    "Kontaktmöglichkeit für Fragen und Hinweise zu dachdeckerjobs.ch.",
  alternates: {
    canonical: "/kontakt",
  },
  openGraph: {
    title: "Kontakt & Support | dachdeckerjobs.ch",
    description: "Kontaktmöglichkeit für Fragen und Hinweise zu dachdeckerjobs.ch.",
    url: "/kontakt",
    type: "website",
  },
  twitter: {
    ...
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      <main id="main-content" className="flex-1 container mx-auto px-4 sm:px-6 py-12 sm:py-16 max-w-lg">
        ...
        <p className="text-slate-600 mb-6 leading-relaxed">
          Haben Sie eine Frage oder einen Hinweis zu dachdeckerjobs.ch? Schreiben
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-6 space-y-4">
          <div>
            ...
            <a
              href="mailto:info@dachdeckerjobs.ch"
              className="text-primary hover:underline text-sm"
            >
              info@dachdeckerjobs.ch
            </a>
          </div>
          <div>
          ...
          <Button asChild className="w-full">
            <a href="mailto:info@dachdeckerjobs.ch">E-Mail senden</a>
          </Button>
        </div>
