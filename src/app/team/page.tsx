...
export const metadata: Metadata = {
  ...
  description:
    "Wer hinter den redaktionellen Inhalten von dachdeckerjobs.ch steht: Recherche, Quellen, Methodik und unser Anspruch an Schweizer Lohn- und Branchendaten.",
  alternates: {
    canonical: "/team",
    ...
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 sm:px-6 py-8 sm:py-12 max-w-3xl">
        ...
        <p className="text-slate-600 mt-3 text-base sm:text-lg leading-relaxed">
          Die Redaktion von dachdeckerjobs.ch erstellt redaktionelle Inhalte zu Berufen,
          Löhnen und regionalen Arbeitsmärkten in der Schweizer Branche
          Dachdeckerei und Gebäudehülle.
        </p>
        ...
        <section className="mt-10 space-y-6">
          <article>
            ...
            <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
              ...
              Stellenanzeigen aus der Schweizer Dachdecker- und
              Gebäudehüllenbranche und sollen Berufsleuten eine schnelle, ehrliche
          ...
          <article>
            ...
            <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
              ...
              der Schweizer Dachdecker- und Gebäudehüllenbranche — insbesondere{" "}
              <a
              ...
              Stellenausschreibungen aus, die auf dachdeckerjobs.ch indexiert
              sind. Die ausgewiesenen Lohnbänder sind Richtgrössen — der
              konkrete Lohn wird im Bewerbungsprozess individuell verhandelt
              und hängt von Erfahrung, Spezialisierung, Arbeitgebergrösse und
              Region ab.
            </p>
          </article>
          ...
          <article>
            ...
            <p className="text-slate-600 text-sm sm:text-base leading-relaxed">
              Inserate werden auf dachdeckerjobs.ch grundsätzlich anonymisiert
