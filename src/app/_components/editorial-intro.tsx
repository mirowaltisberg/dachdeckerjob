...
import type { EditorialContent } from "@/data/editorial/dachdeckerjob";
import { EDITORIAL_BYLINE } from "@/data/editorial/dachdeckerjob";

interface EditorialIntroProps {
  /** Display label for the role, e.g. "Dachdecker EFZ" */
  role: string;
