...
const HOMEPAGE_FAQS = [
  {
    ...
    answer:
      "Eine Karte mit der Kennzeichnung Direktanstellung ist kein konkretes Stelleninserat. Das Team sucht fortlaufend einen passenden Arbeitgeber für das angezeigte Dach- und Gebäudehülleprofil und die gewählten Präferenzen. Ein Arbeitsvertrag kommt ausschliesslich direkt zwischen Fachkraft und diesem Arbeitgeber zustande. Arbeitgeber, Lohn, Starttermin und Verfügbarkeit werden erst nach einer konkreten Abklärung genannt.",
  },
  {
    question: "Welche Stellen finde ich auf dachdeckerjobs.ch?",
    answer:
      "Die Suche bündelt öffentlich zugängliche Stelleninserate mit klarem Bezug zu Dach und Gebäudehülle. Dazu können Stellen für Dachdeckerinnen und Dachdecker, Flachdach- und Fassadenfachkräfte, Servicemonteure sowie Vorarbeiter und Projektleiter gehören. Welche Treffer vorhanden sind, zeigt die aktuelle Ergebnisliste; dachdeckerjobs.ch verspricht weder vollständige Marktabdeckung noch eine bestimmte Zahl an Inseraten.",
  },
  {
    question: "Wie suche ich nach einem Dach- und Fassadenbaujob?",
    answer:
      "Gib eine Berufsbezeichnung oder ein Dach- und Fassadenbau-Stichwort und bei Bedarf einen Ort ein. Die Ergebnisliste lässt sich mit den angebotenen Filtern weiter eingrenzen. Massgebend für Aufgaben, Qualifikation, Pensum, Arbeitsort und Lohn sind die Angaben im jeweiligen Inserat. Fehlt eine Angabe, ergänzt dachdeckerjobs.ch dafür keine pauschale Schätzung.",
  },
  {
    question: "Wie lange dauert die Lehre als Dachdecker/in EFZ?",
    answer:
      "Das offizielle Berufsprofil von berufsberatung.ch nennt für die berufliche Grundbildung Dachdecker/in EFZ eine Dauer von drei Jahren und den Abschluss mit eidgenössischem Fähigkeitszeugnis. Die obligatorische Schule muss abgeschlossen sein. Details zu Ausbildung, Aufgaben und Weiterbildung stehen im verlinkten Berufsprofil.",
  },
  {
    question: "Wie kann ich einen Lohn für eine Dach- und Fassadenbaustelle vergleichen?",
    answer:
...
export function HomepageSeoContent() {
  return (
    <section className="editorial-surface" aria-label="Informationen für Dach- und Fassadenbau-Fachkräfte">
      ...
      <div className="container mx-auto px-4 sm:px-6 py-14 sm:py-20 max-w-6xl">
        ...
        <div className="self-start">
          ...
          <h2 className="text-3xl sm:text-4xl font-black text-foreground mb-5">
            Dach- und Fassadenbaujobs in der Schweiz suchen
          </h2>
          <p className="text-slate-600 text-base sm:text-lg leading-relaxed mb-4">
            dachdeckerjobs.ch bündelt Stelleninserate mit klarem Bezug zum
            Dach- und Fassadenbaugewerk. Suche nach Beruf und Ort und prüfe auf der Detailseite
        ...
        <div className="source-panel p-6 sm:p-8">
          ...
          <ul className="space-y-2 text-sm">
            <li>
              ...
              >
                berufsberatung.ch: Dachdecker/in EFZ
              </a>
            </li>
            <li>
              <a
        ...
        <div className="mb-8 border-t border-border pt-10">
          ...
          <h2 className="text-2xl sm:text-3xl font-black text-foreground mb-3">
            Dach- und Fassadenbaustellen nach Beruf und Kanton
          </h2>
