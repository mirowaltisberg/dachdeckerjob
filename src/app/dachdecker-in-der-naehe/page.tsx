...
import { DACH_CITIES } from "@/lib/dachdecker-cities";

export const metadata: Metadata = {
  title: "Dachdecker in der Nähe | Jobs in deiner Stadt finden",
  description:
    "Dach- und Fassadenbaustellen nach ausgewählten Schweizer Städten und Regionen durchsuchen.",
  alternates: { canonical: "/dachdecker-in-der-naehe" },
  openGraph: {
    title: "Dachdecker in der Nähe | Jobs in deiner Stadt finden",
    description: "Dach- und Fassadenbaustellen nach ausgewählten Schweizer Städten und Regionen durchsuchen.",
    url: "/dachdecker-in-der-naehe",
    type: "website",
  },
  twitter: {
