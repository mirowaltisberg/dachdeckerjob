...
export const DACH_CITIES: DachCity[] = [
  {
    slug: "zuerich",
    name: "Zürich",
    cantonAbbr: "ZH",
...
export function findDachCity(slug: string): DachCity | null {
  return DACH_CITIES.find((city) => city.slug === slug) ?? null;
}
